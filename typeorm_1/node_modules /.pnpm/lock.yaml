...
devDependencies:
  ...
  ts-node-dev:
    specifier: ^2.0.0
    version: 2.0.0(@types/node@20.10.5)(typescript@5.3.3)
...
packages:
  ...
  /ts-node-dev@2.0.0(@types/node@20.10.5)(typescript@5.3.3):
